...
$sql = "SELECT membership, category_title, price, payment, credit, renewal, validity 
        ...
        WHERE ID BETWEEN 'S007' AND 'S011' ";
...
<head>
  ...
  <title>Classes - Private Lessons</title>
...
<body>
  ...
  <div class="directory"><a class="class-link" href="classes.php">Classes</a> > <span class="bold">Private Lessons</span></div>
  ...
  <div class="session-container">
      ...
      $id_counter = 7; // Starting from S007
