...
$sql = "SELECT membership, category_title, price, payment, credit, renewal, validity 
        ...
        WHERE ID BETWEEN 'S013' AND 'S018' ";
...
<head>
  ...
  <title>Classes - Kids Training</title>
  ...
  <script src="scripts/cl-kids-training.js"></script>
...
<body>
  ...
  <div class="directory"><a class="class-link" href="classes.php">Classes</a> > <span class="bold">Kids Training</span></div>
  <p class="title">Kids Training</p>
  ...
  <div class="session-container">
      ...
      $id_counter = 13; // Starting from S013
