...
$sql = "SELECT membership, category_title, price, payment, credit, renewal, validity 
        ...
        WHERE ID BETWEEN 'S023' AND 'S027' ";
...
<head>
  ...
  <script src="scripts/cl-gym-pass.js"></script>
...
<body>
  ...
  <div class="directory"><a class="class-link" href="classes.php">Classes</a> > <span class="bold">Gym Pass</span></div>
  <p class="title">Gym Pass</p>
  ...
  <div class="session-container">
      ...
      $id_counter = 23; // Starting from S023
