...
$sql = "SELECT membership, category_title, price, payment, credit, renewal, validity 
        ...
        WHERE ID BETWEEN 'S001' AND 'S006' ";
...
<head>
  ...
  <title>Classes - Group Sessions</title>
  ...
  <script src="scripts/cl-grp-sessions.js"></script>
...
<body>
  ...
  <div class="directory"><a class="class-link" href="classes.php">Classes</a> > <span class="bold">Group Sessions</span></div>
  <p class="title">Group Sessions</p>

  <div class="categories">
    <p class="all">All</p>
    <p>10 Group Sessions</p>
    <p>26 Group Sessions</p>
    <p>Unlimited Group Sessions</p>
  </div>
